...
export default function Project({ myProject }) {
  ...
  return (
    <a className='max-w-md flex justify-center align-middle' href={myProject.url}>
    <article className=' justify-center items-center border-2 border-neonPink2 rounded-lg p-4 m-4'>
      <header>
        ...
        <div className='inline-block overflow-hidden m-2 ' ><img className=' block transition-all duration-500 hover:scale-125 hover:contrast-125  max-h-80 ' src={myProject.img} width='auto' height='320px'></img></div>
